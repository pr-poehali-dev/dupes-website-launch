      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <p className="text-2xl md:text-3xl text-slate-light mb-4 font-medium">
            магазин качественной и стильной одежды по маленькой цене 🔥
          </p>
          ...
          <div className="flex justify-center mb-16">
            <Button 
              size="lg" 
              className="bg-violet hover:bg-violet-dark text-white font-montserrat font-semibold px-10 py-5 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all"
              onClick={() => {
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-montserrat font-bold text-violet mb-2">100+</div>
